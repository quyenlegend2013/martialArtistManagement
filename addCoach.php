    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
       	...
       	<div class="row mt-2 ml-1">
            	<p><a href="coach.php">Coach</a> / Add Coach</p>
            </div>
            ...
            <div class="row" style="margin-left:10%">
            	<div class="col-5 card card-body">
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="Full Name" name="coachName" required="required" />
                    </div>
                    ...
                    <div class="row mt-3">
                    	<input type="email" class="form-control" placeholder="E-mail" name="coachEmail" required="required" />
                    </div>
                     <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                    	<input type="date" class="form-control"  name="coachDob" />
                    </div>
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="Facebook" name="coachFacebook" />
                    </div>
