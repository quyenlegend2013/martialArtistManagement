    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        ...
        <div class="row collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="col-3"><b style="font-size:24px; margin-left:5%;">List of Exam</b></div>
      ...
      <div class="container-fluid">
                ...
                <div class="row col-md-3" style="margin-left:89%;"><button type="button" class="btn btn-success" onclick="location.href='viewMartialExam.php?examID=<?php echo $id;?>'" >+ Add</button></div>
