...
<body onload="loaddata()">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="statistic.php" class="list-group-item list-group-item-action bg-light">Chart</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
       	...
       	<div class="row mt-2 ml-1">
            	<p><a href="martialArtist.php">Martial artist</a> / Add martial artist</p>
            </div>
           
            
            <form action="xulyAddMartial.php" method="post">
            <div class="row" style="margin-left:10%">
            	<div class="col-5 card card-body">
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="Martial Artist's Name" name="maName" required="required" />
                    </div>
                     
                    <div class="row mt-3">
                    	<input type="date" class="form-control" placeholder="Birthday" name="maDob" />
                    </div>
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="Phone" name="maPhone" />
                    </div>
                ...
                <div class="col-5 card card-body" style="margin-left:2%;">
                   ...
                   <!-- <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                    	<input type="date" class="form-control" placeholder="Date DOA" name="maDoa" />
            ...
            <div class="row" style="margin-left:10%; margin-top:2%;">
            	<div class="col-5 card card-body">
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="School Name" name="school" required="required" />
                    </div>
                </div>
                <div class="col-5 card card-body" style="margin-left:2%">
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="Note" name="maNote" />
