<?php
	...
	$sqlResult="SELECT * FROM result";
	//$sqlEvent="SELECT * FROM event";
	//$sqlClass="SELECT * FROM class";
	//$revalEvent=mysqli_query($conn,$sqlEvent);
	$revalResult=mysqli_query($conn,$sqlResult);
	//$revalClass=mysqli_query($conn,$sqlClass);
	$countResult=mysqli_num_rows($revalResult);
...
<title>Exam Of Martial Artist</title>
...
<script type="text/javascript">
				...
				function deleteResult(maID) {
					if (confirm("Do you want to delete it?")) {
						$.ajax({
							url: 'deleteResult.php?maID=' + maID,
							method: 'POST',
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        ...
        <div class="row collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="col-3"><b style="font-size:24px; margin-left:5%;">Result of exam</b></div>
        ...
        <div class="row mb-4 mt-3">
          <div class="col-12 mb-1 mt-2">
			<div class="card card-stats mb-3">
				<div class="card-body">	
					<div class="row">
                        <div class="col-3"><h4>Result of exam<span class="badge badge-danger"><?php echo $countResult;?></span></h4></div>
                        ...
                        <div class="row">
                         <!-- <div style="margin-left:1.5%;">Show</div>
                          ...
                          <div class="col-2"><button type="button" onclick="location.href='exportResult.php'" class="btn btn-success">Export Data</button></div>
                        </div>
                        <div class="row mt-2">
