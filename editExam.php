<?php
	...
	$examID= $_GET["examID"];
	$sqlEditExam="SELECT * FROM exam WHERE examID='$examID'";
	$queryEditExam=mysqli_query($conn,$sqlEditExam);
	$revalEditExam=mysqli_fetch_array($queryEditExam);
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
       	...
       	<div class="row mt-2 ml-1">
            	<p><a href="exam.php">Exam</a> / Edit Exam</p>
            </div>
           
            
            <form action="xulyEditExam.php" method="post">
            <div class="row" style="margin-left:10%">
            	<div class="col-5 card card-body">
                	<!--<div class="row mt-1">
						<h6 class="card-title">----</h6>
					</div>-->
                    <input type="hidden" value="<?php echo $revalEditExam['examID'];?>" name="examID" />
                    <div class="row mt-3">
                    	<input type="text" class="form-control" value="<?php echo $revalEditExam['examName'];?>" placeholder="Exam Name" name="examName" required="required" />
                    </div>
                     
                    <div class="row mt-3">
                    	<select class="form-control" name="quy">
                        	<option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
                    ...
                    <div class="row mt-3">
                    	<input type="date" class="form-control" value="<?php echo $revalEditExam['examDate'];?>" placeholder="Exam date" name="examDate" />
                    </div>
                ...
                <div class="col-5 card card-body" style="margin-left:2%">
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" value="<?php echo $revalEditExam['examTime'];?>" placeholder="Exam time" name="examTime"/>
                    </div>
                   
                    <div class="row mt-3">
                    	<input  type="text" class="form-control" value="<?php echo $revalEditExam['examiner'];?>" placeholder="Examiner" name="examiner" />
            ...
            <div class="row mt-2">
                ...
                <div class="col-2" style="margin-left:1%;"><button type="reset" class="btn btn-success" onclick="location.href='exam.php'" >Exit</button></div>
            </div>
      </form>            	
