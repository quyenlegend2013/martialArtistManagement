    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
       	...
       	<div class="row mt-2 ml-1">
            	<p><a href="exam.php">Exam</a> / Add Exam</p>
            </div>
           
            
            <form action="xulyAddExam.php" method="post">
            <div class="row" style="margin-left:10%">
            	<div class="col-5 card card-body">
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="Exam Name" name="examName" required="required" />
                    </div>
                    ...
                    <div class="row mt-3">
                    	<input type="date" class="form-control" placeholder="Exam date" name="examDate" />
                    </div>
                ...
                <div class="col-5 card card-body" style="margin-left:2%">
                    ...
                    <div class="row mt-3">
                    	<input type="text" class="form-control" placeholder="Exam time" name="examTime"/>
                    </div>
                   
                    <div class="row mt-3">
                    	<input  type="text" class="form-control" placeholder="Examiner" name="examiner" />
